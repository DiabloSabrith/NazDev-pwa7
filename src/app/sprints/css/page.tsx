    ...
    return(
        ...
        <main className=' w-[95%] h-200   mx-auto flex flex-row items-center text-center my-10 firstRecordBlock   main  gap-10  justify-center'>
            ...
            <section className=' w-[45%] h-[90%] bg-amber-400  flex flex-col  sprintBlock items-center  relative oneSection '>
                ...
                <h3 className='text-[#fff] font-bold text-5xl pt-30 tracking-[4px]'>CSS</h3>
                <p className='text-[#fff]  px-[60px] text-[18px] pt-15 leading-8 text-left'>
                    
                Адаптивная верстка PRO: Создавайте сайты, идеально отображающиеся на любом устройстве! Станьте востребованным верстальщиком за короткий срок!
                Участвуйте в живой Q&A сессии и задайте любые вопросы нашим экспертам – мы позаботимся, чтобы каждый участник получил ответы и научился  создавать свою адаптивную верстку!
