    ...
    return(
        ...
        <main className=' w-[95%] h-200   mx-auto flex flex-row items-center text-center my-10 firstRecordBlock  main  gap-10  justify-center'>
            ...
            <section className=' w-[45%] h-[90%] bg-amber-400  flex flex-col  sprintBlock items-center  relative  oneSection'>
                ...
                <h3 className='text-[#fff] font-bold text-5xl pt-30 tracking-[4px]'>React+Vite<br/>
                Tailwind</h3>
                <p className='text-[#fff]  px-[60px] text-[18px] pt-15 leading-8 text-left'>
                   
                Освойте React, Vite и Tailwind CSS и начните создавать профессиональные веб-сайты! В этом курсе вы разработаете реальный проект под руководством опытного разработчика, который поделится своими знаниями и опытом. Мы обсудим плюсы и минусы каждой технологии и продемонстрируем, как их эффективно использовать для создания высококачественных веб-приложений. 
            ...
            <h2 className='my-10 text-2xl text-[blueviolet] font-semibold'>Oсталось мест : <span className='text-[yellow]'>7/10</span></h2>
            <div className="w-[70%] h-[65%] sprintItem rounded-[15px] transition transform hover:scale-[1.06]   sprintBlock item sprintBlockItem flex justify-center items-center flex-col">
                 <h3 className="text-[#fff] text-4xl tracking-[2px] font-semibold ">React+Vite<br/>
                 Tailwind</h3>
