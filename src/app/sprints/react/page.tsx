    ...
    return(
        ...
        <main className=' w-[95%] h-200   mx-auto flex flex-row items-center text-center my-10 firstRecordBlock  main  gap-10  justify-center'>
            ...
            <section className=' w-[45%] h-[90%] bg-amber-400  flex flex-col  sprintBlock items-center  relative oneSection '>
                ...
                <h3 className='text-[#fff] font-bold text-5xl pt-30 tracking-[4px]'>React</h3>
                <p className='text-[#fff]  px-[60px] text-[18px] pt-15 leading-8 text-left'>
                Погрузись в захватывающий мир React и научись создавать по-настоящему динамичные и интерактивные веб-приложения! Это значит, что ты сможешь создавать веб-сайты, которые моментально реагируют на действия пользователя, плавно обновляют данные без перезагрузки страницы и предлагают богатый, увлекательный пользовательский опыт. На этом интенсивном курсе ты освоишь все необходимые навыки, чтобы воплотить свои самые смелые идеи в реальность!
            ...
            <h2 className='my-10 text-2xl text-[blueviolet] font-semibold'>Oсталось мест : <span className='text-[yellow]'>5/10</span></h2>
