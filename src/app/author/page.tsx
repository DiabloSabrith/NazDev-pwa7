...
export default function Intensivs() {
    return(
        ...
        <main className="w-[95%] h-230   mx-auto flex flex-col items-center text-center my-10 firstRecordBlock ">
            ...
            <section className="w-[90%] h-210  rounded-3xl sprintBlock fideInAnim red bg-[red] ">
                ...
                <div className="w-[90%] h-200 mx-auto flex flex-row flex-wrap  justify-center gap-10  contentBlock pt-10">
                    ...
                    <div className="w-[100%] h-65  text-left text-[18px] px-10  flex items-center justify-center sprintBlock authInfoTwo ">
 ...
 <section className="w-[95%] h-240   flex flex-col mx-auto  items-center gap-10 main">
