    ...
    return(
        ...
        <main className=' w-[95%] h-200   mx-auto flex flex-row items-center text-center my-10 firstRecordBlock    gap-10  justify-center main '>
            ...
            <section className=' w-[45%] h-[90%] bg-amber-400  flex flex-col  sprintBlock items-center  relative oneSection '>
                ...
                <h3 className='text-[#fff] font-bold text-5xl pt-30 tracking-[4px]'>State Managment</h3>
                <p className='text-[#fff]  px-[60px] text-[18px] pt-15 leading-8 text-left'>
                  
                Zustand - от теории к практике! Узнайте, зачем нужен Zustand, как использовать его простой и эффективный API для управления состоянием в React-приложениях, и как он отличается от других state managers. Участвуйте в живой Q&A сессии и задайте любые вопросы нашим экспертам – мы позаботимся, чтобы каждый участник получил ответы и улучшил свои навыки управления состоянием с Zustand!
